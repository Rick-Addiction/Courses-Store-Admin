...
class PutCourseControllerTest {
    ...
    void Given_a_valid_Request_to_put_a_Course_When_its_requested_to_update_a_Course_Then_response_with_the_status_OK() throws Exception {
